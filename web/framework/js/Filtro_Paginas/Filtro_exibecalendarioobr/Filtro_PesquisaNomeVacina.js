...
var campoFiltro = document.querySelector("#filtrar-PesquisaNomeVacina");

campoFiltro.addEventListener("input", function() {
    var pacientes = document.querySelectorAll(".vacina_nome");

    if(this.value.length > 0){

	    for (var i = 0; i < pacientes.length; i++) {
	        var paciente = pacientes[i];
	        var tdNome = paciente.querySelector(".info-VacinaNome");
