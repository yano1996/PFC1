...
function buscarintervalos(calendarioob_id) {
...
if(window.XMLHttpRequest) {
 ...
 var endereco = "listarintervalos";
// Arquivo PHP juntamente com o valor digitado no campo (método GET)
var url = "ControleIntervaloDose?acao="+endereco+"&calendarioob_id="+calendarioob_id;
...
req.onreadystatechange = function() {
	...
	if(req.readyState == 1) {
		document.getElementById('exibetabelaAJAX').innerHTML = 'Buscando Intervalos...';
	}
	...
	document.getElementById('exibetabelaAJAX').innerHTML = resposta;
	}
}
req.send(null);
}
