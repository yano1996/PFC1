                ...
                <div class="col s8">            
                    <div class="card z-depth-2">
                        <div class="card-content">
                            ...
                            <form action="ControleUsuarioNaoLogado" method="POST" >
                                <div class="row">
                                    ...
                                    <div id="id_responsavel" class="col s3 input-field hoverable">
                                        <input type="text" name="txtRgResponsavel" id="txtRgResponsavel" class="hoverable validate" placeholder="00.000.000-00" size="13" maxlength=13>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s4 input-field hoverable">
                                        <input type="text" name="txtRg" id="txtRg" class="hoverable validate" placeholder="00.000.000-00" size="13" maxlength=13 required>
