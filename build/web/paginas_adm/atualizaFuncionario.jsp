                ...
                <div class="col s8">            
                    <div class="card z-depth-2">
                        <div class="card-content">
                            <span class="card-title titulo-tabela center-align">Atualiza Funcionario   <%= nome%> </span>
                            <form action="ControleFuncionario" method="POST" ><br/>
                                 <input name="id_funcionrio" value="<%=funcionarioAtuliza.getId_funcionario()%>" hidden>

                                <div class="row">
                                    <div class="col s4 input-field hoverable">
                                        <input type="text" name="txtCofen" id="txtConfen" class="hoverable validate cpfMaskara" placeholder="000.000.000-00" size="14" maxlength=14 required>
                                        <label class="black-text" for="txtCpf" value="<%=funcionarioAtuliza.getCofen()%>">Confen<i class="material-icons left">account_box</i></label>                                   
                                    </div>
