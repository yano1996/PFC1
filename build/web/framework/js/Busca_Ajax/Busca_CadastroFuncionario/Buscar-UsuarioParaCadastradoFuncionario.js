...
function BuscarUsuario(usuario_rg) {
...
if(window.XMLHttpRequest) {
 ...
 var endereco = "ConsultarUsuarioEspecifico";
// Arquivo PHP juntamente com o valor digitado no campo (método GET)
var url = "ControleUsuario?acao="+endereco+"&usuario_rg="+usuario_rg;
...
req.onreadystatechange = function() {
	...
	if(req.readyState == 1) {
		document.getElementById('tabelausuarioespecifico').innerHTML = 'Buscando Usuario...';
	}
	...
	document.getElementById('tabelausuarioespecifico').innerHTML = resposta;
	}
}
req.send(null);
}
